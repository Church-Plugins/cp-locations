...
<div class="<?php echo $module->get_classname(); ?>">
	...
	<?php else : ?>
		<a href="<?php echo $module->get_link(); ?>"<?php echo ( isset( $settings->link_download ) && 'yes' === $settings->link_download ) ? ' download' : ''; ?> target="<?php echo $settings->link_target; ?>" class="fl-button<?php echo ( 'enable' == $settings->icon_animation ) ? ' fl-button-icon-animation' : ''; ?>"<?php echo $module->get_role(); ?><?php echo $module->get_rel(); ?>>
	<?php endif; ?>
		<?php
